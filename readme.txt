...
Comments Everywhere is a plugin that enables you to insert a comment section where you want by using a shortcode when normally comments are only possible for posts and pages
